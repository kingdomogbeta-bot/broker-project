    ...
    <>
      ...
      <div className="fixed bottom-8 right-8 z-50 flex flex-col gap-4">
        ...
        <button
          ...
          className="w-14 h-14 bg-green-500 hover:bg-green-600 text-white rounded-full shadow-lg flex items-center justify-center transform hover:scale-110 transition-all animate-pulse"
        ...
        <button
          ...
          className="w-14 h-14 bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-700 hover:to-cyan-600 text-white rounded-full shadow-lg flex items-center justify-center transform hover:scale-110 transition-all"
          title="Chat with us"
        >
          <svg
            className="w-6 h-6"
